      ...
      <div className="flex items-center justify-center p-5 sm:p-8 relative min-h-screen lg:min-h-0">
        ...
        <div className="w-full max-w-md bg-[#10101C] border border-white/[0.07] rounded-[20px] p-8 sm:p-12 mt-24 lg:mt-0">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-[#10101C] px-3 text-[#4A4A6A]">or</span></div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 h-11 rounded-xl border border-white/10 bg-white/5 text-sm text-white hover:bg-white/10 transition-colors"
          >
